...
def perform_cs_nn(question_ids, answers, answer_qualities):
    ...
    x_train = tokens[train_idxs]
    x_test = tokens[test_idxs]
    y_train = answer_qualities[train_idxs] - 1
...
if __name__ == '__main__':
    ...
    perform_cs_nn(question_ids, answers, answer_qualities)
